  ...
  ngOnInit() {
    if (localStorage.getItem("score")) {
      ...
      if (
        ...
        this.data =
          "You get along with people very well, and you are the life of any party. you are attentive, caring, and always ready to help, even if you hvae to sacrifice your interests for others. Yet you are very independent in your deals and, as a rule, you get everything without any side help. You only wait for emotional support from your close ones. ";
        this.image =
      ...
      if (
        ...
        this.data =
          "You are the generator of ideas. You are always seeking to create something new. You adapt to non familiar environments fast and master different methods of work easily. Due to your dislike of traditions and routine, you very often chnage your professional spheres and hobbies, becoming an innovator and a pioneer. What is important about you is that not only you can create new ideas but you are also able to convey them to others and make them come true.";
        this.image =
      ...
      if (
        ...
        this.data =
          "You are good at sensing people and their relationships. You can easily identify moods and hidden talents, which is why people seek advice from you. However, you are very vulnerable and can't stand aggression and lack of love. Your driving force is intuition, aimed not outside but inside. This type of person never stops learning, considering self-development to be the main priority. By getting to know yourself, you help others.";
        this.image =
      ...
      if (
        ...
        this.data =
          "You have the richest inner world from where you get incredible ideas. You strive for excellence and want to improve everything and everybody. However, you have some difficulties in relationships with people, very often distancing yourself intentionally to demonstrate your independence. You can set priorities and trust your intuition. In relationships, you very often make a mistake of distancing yourself intentionally to demonstrate your independence.";
        this.image =
    ...
    if (this.score >= 10 && this.score <= 16) {
      this.data2 =
        "You dont seem to be suffering from stress and overall you are balanced and happy";
    }
    if (this.score >= 17 && this.score <= 24) {
      this.isStresssed = true;
      this.data2 =
        "You are a serious worrier and fear that a panic attack could strike at any time. This holds you back from living your life to the fullest.  ";
    }
    if (this.score >= 25 && this.score <= 32) {
      this.isStresssed = true;
      this.data2 =
        "You prefer to be on your own and you struggle to develop relationships with others. You lack empathy and dont exhibit emotions. ";
    }
    if (this.score >= 33 && this.score <= 40) {
      this.isStresssed = true;
      this.data2 =
        "You are burdened by feelings of hopelessness and helplessness and you are not truly engaged in life. You deserve to be happy, healthy and talking to a doctor may help. ";
    }
    ...
    const sketch = (s) => {
      s.setup = () => {
        this.foo.speak(
          `Your Personality comes out to be ${this.heading}. Regarding your stress test result ${this.data2}`
        );
        if (this.isStresssed) {
          this.foo.speak(
            `You should consult a Psychologist for your own good.`
          );
        }
        console.log("hii..");
      };
